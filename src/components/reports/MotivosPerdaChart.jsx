...
// Adicionei colorLight para gradient mais brilhante (similar ao funil)
const ALL_LOST_REASONS = [
    { name: 'Oferta Melhor', field: 'oferta_melhor', color: '#DC2626', colorLight: '#EF4444', shadow: '0 6px 16px rgba(220, 38, 38, 0.7)' },
    { name: 'Incerteza', field: 'incerteza', color: '#F59E0B', colorLight: '#FBBF24', shadow: '0 6px 16px rgba(245, 158, 11, 0.7)' },
    { name: 'Geração Própria', field: 'geracao_propria', color: '#10B981', colorLight: '#34D399', shadow: '0 6px 16px rgba(16, 185, 129, 0.7)' },
    ...
    { name: 'Restrições Técnicas', field: 'restricoes_tecnicas', color: '#3B82F6', colorLight: '#60A5FA', shadow: '0 6px 16px rgba(59, 130, 246, 0.7)' },
    { name: 'Não é o Responsável', field: 'nao_responsavel', color: '#F472B6', colorLight: '#FCA5D7', shadow: '0 6px 16px rgba(244, 114, 182, 0.7)' },
    { name: 'Silêncio', field: 'silencio', color: '#6B7280', colorLight: '#9CA3AF', shadow: '0 6px 16px rgba(107, 114, 128, 0.7)' },
    { name: 'Já Possui GD', field: 'ja_possui_gd', color: '#EAB308', colorLight: '#FCD34D', shadow: '0 6px 16px rgba(234, 179, 8, 0.7)' },
    { name: 'Outro Estado', field: 'outro_estado', color: '#14B8A6', colorLight: '#2DD4BF', shadow: '0 6px 16px rgba(20, 184, 166, 0.7)' },
];
...
const MotivosPerdaChart = ({ lostReasons }) => {
    ...
    // Ordenação: ativos no topo, decrescente por count
    ...
    // Dimensionamento dinâmico (só conta ativas para redução)
    const MAX_WIDTH = 96; 
    const REDUCTION_STEP = 8; 
    const MIN_ACTIVE_WIDTH = 25; // Mínimo maior para barras com poucos leads ficarem visíveis
    ...
    const finalChartData = sortableData.map((item) => {
        ...
        if (isActive) {
            ...
            widthPercent = 12; // Inativas finas
        }
