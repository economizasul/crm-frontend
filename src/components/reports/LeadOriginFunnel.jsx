...
const FUNNEL_STAGES = [
    { name: "Facebook", baseColor: "bg-blue-600", shadowStyle: "shadow-2xl shadow-blue-500/50" },
    { name: "Orgânico", baseColor: "bg-green-600", shadowStyle: "shadow-xl shadow-green-500/50" },
    { name: "Google", baseColor: "bg-yellow-600", shadowStyle: "shadow-lg shadow-yellow-500/50" },
    { name: "Indicação", baseColor: "bg-purple-600", shadowStyle: "shadow-md shadow-purple-500/50" },
    { name: "Instagram", baseColor: "bg-pink-600", shadowStyle: "shadow-md shadow-pink-500/50" },
    { name: "Parceria", baseColor: "bg-red-600", shadowStyle: "shadow-sm shadow-red-500/50" },
];
...
const LeadOriginFunnel = ({ originStats, totalLeads }) => {
    ...
    return (
        <div className="flex flex-col items-center pt-8 px-4 relative">
            ...
            {/* TOPO DO FUNIL (OVAL SIMPLES) */}
            {/* Esta div é puramente estética, imitando a borda superior do funil 3D */}
            <motion.div 
            ...
            <div className="w-full max-w-sm flex flex-col items-center mt-4">
                {funnelData.map((item, index) => {
                    ...
                    // Estilo de funil é feito pela largura proporcional e centralização (margin: 0 auto)
                    ...
                    return (
                        <motion.div
                            ...
                            className="w-full flex justify-center mt-[-10px] z-[10]" // mt-[-10px] para sobreposição
                            style={{ margin: '0 auto' }} 
                        >
                            <div 
