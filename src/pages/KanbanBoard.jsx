...
const STAGES = {
  ...
  'Contato': 'bg-blue-100 text-blue-800 border-blue-300',
  'Retorno': 'bg-indigo-100 text-indigo-800 border-indigo-300',
  ...
  'Desqualificado': 'bg-orange-100 text-red-800 border-red-300',
};
