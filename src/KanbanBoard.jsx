...
// 🚨 CORREÇÃO APLICADA: Exportando STAGES para ser usada no LeadSearch.jsx
export const STAGES = [
...
const KanbanBoard = () => {
    ...
    const fetchLeads = useCallback(async () => {
        ...
        try {
            ...
            const groupedLeads = allLeads.reduce((acc, lead) => {
                // Se o status não for um dos definidos, coloca em 'Para Contatar'
    ...
    const saveLeadChanges = async () => {
        ...
        try {
            ...
            // Recarrega os leads para atualizar o Kanban com as novas informações
            await fetchLeads(); 
                            ...
                            <div>
                                ...
                                <div className="max-h-40 overflow-y-auto border p-3 rounded-lg bg-white shadow-inner">
                                    {selectedLead.notes && selectedLead.notes.length > 0 ? (
                                        [...selectedLead.notes]
                                            // Adiciona a nova nota temporariamente para visualização
